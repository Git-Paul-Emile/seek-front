...
const CTASection = () => (
  <section className="relative py-24 bg-[#0C1A35] overflow-clip">
    <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-[#D4A843] opacity-[0.04] blur-3xl -translate-y-1/3 pointer-events-none" />
