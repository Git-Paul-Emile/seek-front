...
import { Receipt, Download, Plus, Calculator, Users, DollarSign, Calendar } from 'lucide-react';

export default function AgencyChargesPage() {
  ...
  const [selectedPaymentCharge, setSelectedPaymentCharge] = useState<Charge | null>(null);
  ...
  // Filtrer les charges par onglet
  const filteredCharges = charges.filter(charge => {
    if (activeTab === 'all') return true;
    return charge.statut === activeTab;
  });
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <PageHeader
        ...
        icon={Receipt}
        description="Gérez les charges locatives et leur répartition"
        action={
          <>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="envoye">Envoyées</TabsTrigger>
          <TabsTrigger value="partiel">Partielles</TabsTrigger>
