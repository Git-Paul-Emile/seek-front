...
const AgencyLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await agencyAuth.login({ email, password });
      toast({
  ...
  const handleGoogleLogin = () => {
    agencyAuth.loginWithGoogle();
  };

  const handleFacebookLogin = () => {
    agencyAuth.loginWithFacebook();
  };
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Seek - Agence</CardTitle>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/agency/forgot-password" className="text-sm text-primary hover:underline">
                Mot de passe oublié ?
              </Link>
            </div>
        ...
        <CardFooter className="flex flex-col gap-4">
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/agency/register" className="text-primary hover:underline">
              Créer un compte
            </Link>
          </p>
