...
import { useLocataireNotifications, useMarkLocataireNotificationsRead, useMarkLocataireOneNotificationRead } from "@/hooks/useNotificationInApp";
...
export default function NotificationsLocatairePage() {
  const { data, isLoading } = useLocataireNotifications();
  const { mutate: markRead, isPending: marking } = useMarkLocataireNotificationsRead();
